  ...
  return (function () {
    function n(t, a) {
      ...
      !(function (e, t) {
        ...
        this.HTMLElement &&
          ((this.type =
            null !== (l = null == a ? void 0 : a.type) && void 0 !== l
              ? l
              : "default"),
          (this.date = {
            min:
          ...
          (this.settings = {
            lang:
              null !==
                (u =
                  null == a || null === (v = a.settings) || void 0 === v
                    ? void 0
                    : v.lang) && void 0 !== u
                ? u
                : "en",
            iso8601:
              null ===
                (h =
                  null == a || null === (g = a.settings) || void 0 === g
                    ? void 0
                    : g.iso8601) ||
              void 0 === h ||
              h,
              ...
              templateHeader:
                null !==
                  (de =
                    ...
                    null === (oe = a.settings) ||
                    void 0 === oe ||
                    null === (ue = oe.visibility) ||
                    void 0 === ue
                      ? void 0
                      : ue.templateHeader) && void 0 !== de
                  ? de
                  : "%M %Y",
              monthShort:
                null ===
          ...
          (this.locale = {
            months:
              null !==
                (He =
                  null == a || null === (Ye = a.locale) || void 0 === Ye
                    ? void 0
                    : Ye.months) && void 0 !== He
                ? He
                : [],
            weekday:
              null !==
                (Ce =
                  null == a || null === (Ue = a.locale) || void 0 === Ue
                    ? void 0
                    : Ue.weekday) && void 0 !== Ce
                ? Ce
                : [],
          }),
          (this.actions = {
            clickDay:
              null !==
                (xe =
                  null == a || null === (Ee = a.actions) || void 0 === Ee
                    ? void 0
                    : Ee.clickDay) && void 0 !== xe
                ? xe
                : null,
            clickMonth:
              null !==
                (Ne =
                  null == a || null === (Ae = a.actions) || void 0 === Ae
                    ? void 0
                    : Ae.clickMonth) && void 0 !== Ne
                ? Ne
                : null,
            clickYear:
              null !==
                (Se =
                  null == a || null === (Ke = a.actions) || void 0 === Ke
                    ? void 0
                    : Ke.clickYear) && void 0 !== Se
                ? Se
                : null,
            changeTime:
              null !==
                (Fe =
                  null == a || null === (qe = a.actions) || void 0 === qe
                    ? void 0
                    : qe.changeTime) && void 0 !== Fe
                ? Fe
                : null,
          }),
          (this.popups =
            null !== (Oe = null == a ? void 0 : a.popups) && void 0 !== Oe
              ? Oe
              : null),
      ...
      (s = [
        ...
        },
        {
          ...
          value: function () {
            ...
            var t =
              !0 === this.settings.selection.time ||
              12 === this.settings.selection.time;
        ...
        },
        {
          ...
          value: function () {
            ...
            if (["default", "year"].includes(this.currentType)) {
              var t = this.HTMLElement.querySelector(
              ...
              !(function () {
                if ("default" === e.currentType) {
                  ...
                  (n && s) || !e.settings.selection.month
                    ? (t.style.visibility = "hidden")
                    : (t.style.visibility = null),
                    (l && i) || !e.settings.selection.month
        ...
        },
        {
          ...
          value: function (e, t) {
            if (this.settings.visibility.weekNumbers) {
              ...
              (s.className = "vanilla-calendar-week-number"),
                (a.innerHTML = "");
              for (var i = 0; i < l; i++) {
                var c = this.getWeekNumber(n[7 * i].dataset.calendarDay),
                  r = s.cloneNode(!0);
                (r.innerText = "".concat(c.week)),
                  (r.dataset.calendarYearWeek = "".concat(c.year)),
                  a.append(r);
              }
            }
          },
              ...
              for (var t in this.popups)
                if (Object.hasOwnProperty.call(this.popups, t)) {
                  var a = e.querySelector(
                    '[data-calendar-day="'.concat(t, '"]')
                  );
                  if (a) {
                    var n = this.popups[t];
                    a.classList.add(n.modifier),
        ...
        },
        {
          ...
          value: function () {
            ...
            (s.className = "vanilla-calendar-day"),
              ...
              ) && l.classList.add("vanilla-calendar-days_selecting"),
              (l.innerHTML = "");
              ...
              r && o.classList.add(r),
                ...
                (function (t, a, n, l) {
                  !e.settings.visibility.weekend ||
                    (0 !== a && 6 !== a) ||
                    t.classList.add("vanilla-calendar-day__btn_weekend"),
                    Array.isArray(e.settings.selected.holidays) &&
                      e.settings.selected.holidays.forEach(function (e) {
                        e === n &&
                          t.classList.add("vanilla-calendar-day__btn_holiday");
                      });
                  ...
                  (s = s < 10 ? "0".concat(s) : s),
                    (i = i < 10 ? "0".concat(i) : i);
                  var c = ""
                    .concat(e.date.today.getUTCFullYear(), "-")
                    .concat(i, "-")
                    .concat(s);
                  e.settings.visibility.today &&
                    t.dataset.calendarDay === c &&
                    t.classList.add("vanilla-calendar-day__btn_today"),
                    0 === e.selectedDates.indexOf(n) ||
                    (e.selectedDates[0] &&
                      e.selectedDates.indexOf(n) === e.selectedDates.length - 1)
                      ? t.classList.add("vanilla-calendar-day__btn_selected")
                      : "multiple-ranged" === e.settings.selection.day &&
                        e.selectedDates.indexOf(n) > 0
                      ? (t.classList.add("vanilla-calendar-day__btn_selected"),
                        t.classList.add(
                      ...
                      : e.selectedDates.indexOf(n) > 0 &&
                        t.classList.add("vanilla-calendar-day__btn_selected"),
                    (e.settings.range.min > n || e.settings.range.max < n) &&
                      t.classList.add("vanilla-calendar-day__btn_disabled"),
                    e.settings.selection.month ||
                      l ||
                      t.classList.add("vanilla-calendar-day__btn_disabled"),
                    e.settings.selection.year ||
                      new Date(n).getFullYear() === e.selectedYear ||
                      t.classList.add("vanilla-calendar-day__btn_disabled"),
            ...
            !(function () {
              var t =
                ...
                l = e.selectedMonth;
              0 === e.selectedMonth
                ? ((l = e.locale.months.length), (a = e.selectedYear - 1))
                : e.selectedMonth < 10 && (l = "0".concat(e.selectedMonth));
              for (var s = 0; s < n; s++) {
                t += 1;
              ...
              (function () {
                ...
                e.selectedMonth + 1 === e.locale.months.length
                  ? ((r = "01"), (i = e.selectedYear + 1))
                  : e.selectedMonth + 2 < 10 &&
                    (r = "0".concat(e.selectedMonth + 2));
                for (var d = 1; d <= s; d++) {
                  var o = d < 10 ? "0".concat(d) : d,
                    u = "".concat(i, "-").concat(r, "-").concat(o),
                    v =
                      new Date(
                        Date.UTC(e.selectedYear, e.selectedMonth, d)
                      ).getUTCMonth() + 1,
        ...
        },
        {
          key: "changeMonth",
          value: function (e) {
            var t = this.locale.months.length;
            switch (e) {
              case "prev":
                0 !== this.selectedMonth
                  ? (this.selectedMonth -= 1)
                  : this.settings.selection.year &&
                    ((this.selectedYear -= 1), (this.selectedMonth = t));
                break;
              case "next":
        ...
        },
        {
          ...
          value: function () {
            ...
            var t = document.createElement("button");
            (t.type = "button"),
              (t.className = "vanilla-calendar-months__month");
        ...
        },
        {
          ...
          value: function (e) {
            var t = this,
              a = this.HTMLElement.querySelector(
                '.vanilla-calendar-time__range input[name="hours"]'
              ),
              n = this.HTMLElement.querySelector(
                '.vanilla-calendar-time__range input[name="minutes"]'
              ),
              l = this.HTMLElement.querySelector(
                '.vanilla-calendar-time__hours input[name="hours"]'
              ),
              s = this.HTMLElement.querySelector(
                '.vanilla-calendar-time__minutes input[name="minutes"]'
              ),
              i = this.HTMLElement.querySelector(
              ...
              d = function (e, a, n) {
                "hours" === n
                  ? (t.selectedHours = "".concat(a))
                  : "minutes" === n && (t.selectedMinutes = "".concat(a)),
                  (t.selectedTime = ""
                    .concat(t.selectedHours, ":")
                    .concat(t.selectedMinutes)
                    .concat(
                      t.selectedKeeping ? " ".concat(t.selectedKeeping) : ""
                    )),
                  (t.settings.selected.time = t.selectedTime),
                  t.actions.changeTime &&
                    t.actions.changeTime(
                      e,
                      t.selectedTime,
                      t.selectedHours,
                  ...
                  (s = s < 10 ? "0".concat(s) : "".concat(s)),
                    "hours" === n && 12 === l
                      ? Number(e.target.value) < l && Number(e.target.value) > 0
                        ? ((a.value = s),
                          (t.selectedKeeping = "AM"),
                          (i.innerText = t.selectedKeeping),
                          d(e, s, n))
                        : (0 === Number(e.target.value)
                            ? ((t.selectedKeeping = "AM"), (i.innerText = "AM"))
                            : ((t.selectedKeeping = "PM"),
                              (i.innerText = "PM")),
              ...
              u = function (e, a, n, l) {
                a.addEventListener("change", function (a) {
                  ...
                  (s = s < 10 ? "0".concat(s) : "".concat(s)),
                    "hours" === n && 12 === l
                      ? a.target.value &&
                        Number(a.target.value) <= l &&
                        Number(a.target.value) > 0
                        ? ((a.target.value = s),
                          (e.value = t.transformTime24(s, t.selectedKeeping)),
                          d(a, s, n))
                        : a.target.value &&
                          Number(a.target.value) < 24 &&
                          (Number(a.target.value) > l ||
                            0 === Number(a.target.value))
                        ? (0 === Number(a.target.value)
                            ? ((t.selectedKeeping = "AM"), (i.innerText = "AM"))
                            : ((t.selectedKeeping = "PM"),
                              (i.innerText = "PM")),
            ...
            c(a, l),
              ...
              i &&
                i.addEventListener("click", function (e) {
                  i.innerText.includes("AM")
                    ? (t.selectedKeeping = "PM")
                    : (t.selectedKeeping = "AM"),
                    (a.value = t.transformTime24(
                      t.selectedHours,
                      t.selectedKeeping
                    )),
            ...
            if (e) {
              ...
              (e.innerHTML =
                '\n\t\t<div class="vanilla-calendar-time__content">\n\t\t\t<label class="vanilla-calendar-time__hours">\n\t\t\t\t<input type="text"\n\t\t\t\t\tname="hours"\n\t\t\t\t\tmaxlength="2"\n\t\t\t\t\tvalue="'
                  ...
                  .concat(
                    12 === t
                      ? '\n\t\t\t<button type="button"\n\t\t\t\tclass="vanilla-calendar-time__keeping"\n\t\t\t\t'
                          .concat(a ? "disabled" : "", ">")
                          .concat(this.selectedKeeping, "</button>\n\t\t\t")
                      : "",
                    '\n\t\t</div>\n\t\t<div class="vanilla-calendar-time__ranges">\n\t\t\t<label class="vanilla-calendar-time__range">\n\t\t\t\t<input type="range"\n\t\t\t\t\tname="hours"\n\t\t\t\t\tmin="0"\n\t\t\t\t\tmax="23"\n\t\t\t\t\tstep="'
                  )
                  .concat(
                    this.settings.selection.stepHours,
                    '"\n\t\t\t\t\tvalue="'
                  )
                  .concat(
                    this.selectedKeeping
                      ? this.transformTime24(
                          this.selectedHours,
                          this.selectedKeeping
                        )
                      : this.selectedHours,
                  ...
                  .concat(
                    this.settings.selection.stepMinutes,
                    '"\n\t\t\t\t\tvalue="'
                  )
                  .concat(
                    this.selectedMinutes,
          ...
          value: function () {
            ...
            this.HTMLElement.addEventListener("click", function (t) {
              ...
              a &&
                "year" !== e.currentType &&
                "month" !== e.currentType &&
                e.changeMonth(t.target.dataset.calendarArrow),
                (function () {
                  if (
                    ["single", "multiple", "multiple-ranged"].includes(
                      ...
                      case "single":
                        s.classList.contains(
                          ...
                          ? e.selectedDates.splice(
                              e.selectedDates.indexOf(s.dataset.calendarDay),
                              1
                            )
                          : ((e.selectedDates = []),
                      ...
                      case "multiple-ranged":
                        !(function () {
                          if (
                            ...
                            var t = new Date(
                                Date.UTC(
                                  new Date(e.selectedDates[0]).getUTCFullYear(),
                              ...
                              a = new Date(
                                Date.UTC(
                                  new Date(e.selectedDates[1]).getUTCFullYear(),
                              ...
                              n = function (t) {
                                ...
                                (e.settings.range.disabled &&
                                  e.settings.range.disabled.includes(a)) ||
                                  e.selectedDates.push(a);
                              };
                ...
                e.settings.selection.year &&
                  (a && "year" === e.currentType
                    ? (l ? (e.viewYear += 15) : n && (e.viewYear -= 15),
                      e.createYears())
                    ...
                    : d &&
                      ...
                      e.selectedMonth < e.dateMin.getUTCMonth() &&
                        e.selectedYear === e.dateMin.getUTCFullYear() &&
                        (e.settings.selected.month = e.dateMin.getUTCMonth()),
                      e.selectedMonth > e.dateMax.getUTCMonth() &&
                        e.selectedYear === e.dateMax.getUTCFullYear() &&
                        (e.settings.selected.month = e.dateMax.getUTCMonth()),
                      e.actions.clickYear &&
...
const calendar = new VanillaCalendar(".date-con", {
  type: "default",
  date: {
    min: `${d.getFullYear()}-${getCurrentMonth()}-${d.getDate()}`,
    max: `${d.getFullYear() + 10}-${getCurrentMonth()}-${d.getDate()}`,
    today: new Date(`${d.getFullYear()}-${getCurrentMonth()}-${d.getDate()}`),
  },

  settings: {
    range: {
      min: new Date(`${d.getFullYear()}-${getCurrentMonth()}-${d.getDate()}`),
      max: new Date(
        `${d.getFullYear() + 10}-${getCurrentMonth()}-${d.getDate()}`
      ),
    },
  },
  actions: {
    clickDay(e, dates) {
      if (
        e.target.classList.contains("vanilla-calendar-day__btn_next") ||
        e.target.classList.contains("vanilla-calendar-day__btn_prev")
      ) {
      } else {
        const dueDate = e.target.closest(".due-date");
        const clickedDate = e.target.getAttribute("data-calendar-day");
        let clickedMonth = document
          .querySelector(".vanilla-calendar-month")
          .textContent.slice(0, 3);
        let clickedDay = parseInt(
          e.target.getAttribute("data-calendar-day").split("-")[2]
        );
        dueDate.setAttribute("data-due-date", clickedDate);
        dueDate.children[1].textContent = `${clickedDay} ${clickedMonth}`;
        let dateCont = document.querySelector(".date-con");
        dateCont.classList.toggle("calendar-show");
      }
    },
  },
});
...
function preventPreviousDates() {
  let month = document.querySelector(".vanilla-calendar-month");
  month = parseInt(month.getAttribute("data-calendar-selected-month"));
  if (month == 13) {
    month = 0;
  }
  ...
  if (month == d.getUTCMonth()) {
    for (let i = 0; i < days.length - 1; i++) {
      let dayValue = parseInt(
        days[i].getAttribute("data-calendar-day").split("-")[2]
      );
      let monthValue = parseInt(
        days[i].getAttribute("data-calendar-day").split("-")[1]
      );
      if (dayValue == d.getUTCDate() && monthValue == getCurrentMonth()) {
        break;
      } else {
...
let previousArrow = document.querySelector(".vanilla-calendar-arrow_prev");
let nextArrow = document.querySelector(".vanilla-calendar-arrow_next");
function clickPreventedDay() {
  let previousMonthDays = document.querySelectorAll(
    ".vanilla-calendar-day__btn_prev"
  );
